...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [-118.113491, 34.111743],
    // zoom: 10,
    // interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extends map bounds to include currwent location
...
var stripe = Stripe('pk_test_51HUUJjKBiwuz4Dv0kAPgz5c2m7NY3BTiYQpeDBuCPRXcSS0beEF4Lchl6fim5GW9W5dOF6tY9TBTRQQk3ufZpgeW00D5QI14ZF');
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              document.querySelector('.btn-change').textContent = 'Creating...';
              name = document.getElementById('name').value;
              email = document.getElementById('Semail').value;
              password = document.getElementById('Spassword').value;
              passwordConfirm = document.getElementById('SpasswordConfirm').value;
              _context.next = 8;
              return (0, _signup.signup)(name, email, password, passwordConfirm);

            case 8:
              document.querySelector('.btn-change').textContent = 'Sign Up';
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 7:
              //Clearing Password fields after updating
